...
extern __IEC_INT_t CONFIG__TUTU;
extern __IEC_INT_t CONFIG__TEST_PYTHON_VAR;
extern __IEC_INT_t CONFIG__SECOND_PYTHON_VAR;
extern __IEC_SINT_t CONFIG__TESTINPUT;
extern __IEC_SINT_t CONFIG__TESTOUTPUT;
...
{&(CONFIG__TUTU), INT_ENUM},
{&(CONFIG__TEST_PYTHON_VAR), INT_ENUM},
{&(CONFIG__SECOND_PYTHON_VAR), INT_ENUM},
{&(CONFIG__TESTINPUT), SINT_ENUM},
{&(CONFIG__TESTOUTPUT), SINT_ENUM},
{&(CONFIG__SOMEVARNAME), DINT_ENUM},
{&(CONFIG__GRUMPF), STRING_ENUM},
{&(RES_PYTEST__TOTO), INT_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.MUX1_SEL), INT_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.MUX2_SEL), INT_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.PYTEST_VAR1), STRING_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.FEFVSD), BOOL_ENUM},
...
{&(RES_PYTEST__PYTEST_INSTANCE.TESTOUTPUT), SINT_P_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.FROMINPUT), SINT_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.TEST_BCD), WORD_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.TEST_BCD_WRONG), WORD_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.TEST_BCD_CONVERTED), BOOL_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.TEST_BCD_RESULT), UINT_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.TEST_BCD_WRONG_RESULT), UINT_ENUM},
...
{&(RES_PYTEST__PYTEST_INSTANCE.TUTU), INT_P_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.TOTO), INT_P_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.TEST_PYTHON_VAR), INT_P_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.SECOND_PYTHON_VAR), INT_P_ENUM},
...
{&(RES_PYTEST__PYTEST_INSTANCE.FUNCTION061_OUT), BOOL_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.BCD_TO_UINT35_OUT), UINT_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.BCD_TO_UINT67_ENO), BOOL_ENUM},
{&(RES_PYTEST__PYTEST_INSTANCE.BCD_TO_UINT67_OUT), UINT_ENUM},
...
{&(RES_PYTEST__PYTEST_INSTANCE.INT_TO_STRING46_OUT), STRING_ENUM},
