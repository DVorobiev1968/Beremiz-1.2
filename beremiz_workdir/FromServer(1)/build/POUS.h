...
typedef struct {
  ...
  __DECLARE_VAR(LREAL,D_VALUE)
  PYTHON_EVAL PYTHON_EVAL1;
  __DECLARE_VAR(BOOL,NOT8_OUT)
  __DECLARE_VAR(LREAL,STRING_TO_LREAL10_OUT)
...
typedef struct {
  ...
  __DECLARE_VAR(STRING,SET_LOAD_PARAM8_OUT)
  __DECLARE_VAR(LREAL,STRING_TO_LREAL1_OUT)
...
typedef struct {
  ...
  __DECLARE_VAR(REAL,LREAL_TO_REAL19_OUT)
