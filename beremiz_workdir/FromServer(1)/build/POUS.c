...
void MAINSERVER1_init__(MAINSERVER1 *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->NOT8_OUT,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->STRING_TO_LREAL10_OUT,0,retain)
  __INIT_VAR(data__->NOT4_OUT,__BOOL_LITERAL(FALSE),retain)
}

// Code part
void MAINSERVER1_body__(MAINSERVER1 *data__) {
  // Initialise TEMP variables

  __SET_VAR(data__->,NOT8_OUT,,!(__GET_VAR(data__->TRIGGER,)));
  __SET_VAR(data__->,TRIGGER,,__GET_VAR(data__->NOT8_OUT,));
  __SET_VAR(data__->PYTHON_EVAL0.,TRIG,,__GET_VAR(data__->NOT8_OUT,));
  __SET_VAR(data__->PYTHON_EVAL0.,CODE,,__STRING_LITERAL(29,"load_socket_node(5, 0x1000+7)"));
  PYTHON_EVAL_body__(&data__->PYTHON_EVAL0);
  __SET_VAR(data__->,STRING_TO_LREAL10_OUT,,STRING_TO_LREAL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (STRING)__GET_VAR(data__->PYTHON_EVAL0.RESULT,)));
  __SET_VAR(data__->,D_VALUE,,__GET_VAR(data__->STRING_TO_LREAL10_OUT,));
  __SET_VAR(data__->,NOT4_OUT,,!(__GET_VAR(data__->TRIGGER0,)));
  __SET_VAR(data__->,TRIGGER0,,__GET_VAR(data__->NOT4_OUT,));
  __SET_VAR(data__->PYTHON_EVAL1.,TRIG,,__GET_VAR(data__->NOT4_OUT,));
  __SET_VAR(data__->PYTHON_EVAL1.,CODE,,__STRING_LITERAL(34,"set_socket_node(5,0x1000+8,3,1968)"));
  ...
  INT ID_SUBOBJ)
{
  ...
  STRING SET_LOAD_PARAM = __STRING_LITERAL(0,"");
  ...
  if (!EN) {
    ...
    return SET_LOAD_PARAM;
  }
  SET_LOAD_PARAM = CONCAT(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (UINT)5,
    (STRING)__STRING_LITERAL(17,"load_socket_node("),
...
void LOAD_SOCKET_NODE_init__(LOAD_SOCKET_NODE *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->SET_LOAD_PARAM8_OUT,__STRING_LITERAL(0,""),retain)
  __INIT_VAR(data__->STRING_TO_LREAL1_OUT,0,retain)
}
...
void LOAD_SOCKET_NODE_body__(LOAD_SOCKET_NODE *data__) {
  ...
  __SET_VAR(data__->,SET_LOAD_PARAM8_OUT,,SET_LOAD_PARAM(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
  ...
  __SET_VAR(data__->PYTHON_EVAL0.,CODE,,__GET_VAR(data__->SET_LOAD_PARAM8_OUT,));
  PYTHON_EVAL_body__(&data__->PYTHON_EVAL0);
  __SET_VAR(data__->,STRING_TO_LREAL1_OUT,,STRING_TO_LREAL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (STRING)__GET_VAR(data__->PYTHON_EVAL0.RESULT,)));
  __SET_VAR(data__->,D_VALUE,,__GET_VAR(data__->STRING_TO_LREAL1_OUT,));
...
void MAINSERVER_init__(MAINSERVER *data__, BOOL retain) {
  __INIT_VAR(data__->ID_NODE,5,retain)
  __INIT_VAR(data__->I_OBJ,4103,retain)
  ...
  __INIT_VAR(data__->LREAL_TO_REAL19_OUT,0,retain)
...
void MAINSERVER_body__(MAINSERVER *data__) {
  ...
  __SET_VAR(data__->,LREAL_TO_REAL19_OUT,,LREAL_TO_REAL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (LREAL)__GET_VAR(data__->D_VALUE,)));
  ...
  __SET_VAR(data__->INTEGRAL0.,XIN,,__GET_VAR(data__->LREAL_TO_REAL19_OUT,));
