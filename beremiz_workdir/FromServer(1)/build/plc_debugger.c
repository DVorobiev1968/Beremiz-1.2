 ...
 * Declare programs 
 **/
extern MAINSERVER RESOURCE1__SRV;
...
{&(RESOURCE1__SRV.D_VALUE), LREAL_ENUM},
{&(RESOURCE1__SRV.D_VAL_OUT_1), REAL_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.EN), BOOL_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.ENO), BOOL_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.TRIG), BOOL_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.CODE), STRING_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.ACK), BOOL_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.RESULT), STRING_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.STATE), DWORD_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.BUFFER), STRING_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.PREBUFFER), STRING_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.TRIGM1), BOOL_ENUM},
{&(RESOURCE1__SRV.PYTHON_EVAL1.TRIGGED), BOOL_ENUM},
...
{&(RESOURCE1__SRV.LOAD_SOCKET_NODE0.D_VALUE), LREAL_ENUM},
{&(RESOURCE1__SRV.LOAD_SOCKET_NODE0.NOT2_OUT), BOOL_ENUM},
{&(RESOURCE1__SRV.LOAD_SOCKET_NODE0.SET_LOAD_PARAM8_OUT), STRING_ENUM},
{&(RESOURCE1__SRV.LOAD_SOCKET_NODE0.STRING_TO_LREAL1_OUT), LREAL_ENUM},
{&(RESOURCE1__SRV.INTEGRAL0.EN), BOOL_ENUM},
{&(RESOURCE1__SRV.INTEGRAL0.ENO), BOOL_ENUM},
{&(RESOURCE1__SRV.INTEGRAL0.RUN), BOOL_ENUM},
{&(RESOURCE1__SRV.INTEGRAL0.R1), BOOL_ENUM},
{&(RESOURCE1__SRV.INTEGRAL0.XIN), REAL_ENUM},
{&(RESOURCE1__SRV.INTEGRAL0.X0), REAL_ENUM},
{&(RESOURCE1__SRV.INTEGRAL0.CYCLE), TIME_ENUM},
{&(RESOURCE1__SRV.INTEGRAL0.Q), BOOL_ENUM},
{&(RESOURCE1__SRV.INTEGRAL0.XOUT), REAL_ENUM},
{&(RESOURCE1__SRV.CYCLE), STRING_ENUM},
{&(RESOURCE1__SRV.NOT14_OUT), BOOL_ENUM},
{&(RESOURCE1__SRV.LREAL_TO_REAL19_OUT), REAL_ENUM},
{&(RESOURCE1__SRV.STRING_TO_TIME21_OUT), TIME_ENUM}
};
