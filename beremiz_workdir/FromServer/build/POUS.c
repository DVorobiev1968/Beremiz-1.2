...
void MAINSERVER_body__(MAINSERVER *data__) {
  ...
  __SET_VAR(data__->PYTHON_EVAL0.,TRIG,,__GET_VAR(data__->TRIGGER,));
  __SET_VAR(data__->PYTHON_EVAL0.,CODE,,__STRING_LITERAL(10,"getValue()"));
  PYTHON_EVAL_body__(&data__->PYTHON_EVAL0);
  __SET_VAR(data__->,S_OUT,,__GET_VAR(data__->PYTHON_EVAL0.RESULT,));
  __SET_VAR(data__->PYTHON_EVAL1.,TRIG,,__GET_VAR(data__->TRIGGER0,));
  __SET_VAR(data__->PYTHON_EVAL1.,CODE,,__STRING_LITERAL(6,"main()"));
