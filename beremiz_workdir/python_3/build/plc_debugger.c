...
{&(CONFIG__TEST), INT_ENUM},
{&(RESOURCE1__MAIIN.IN), INT_ENUM},
{&(RESOURCE1__MAIIN.OUT), INT_ENUM},
{&(RESOURCE1__MAIIN.B_TRIGER), BOOL_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.EN), BOOL_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.ENO), BOOL_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.TRIG), BOOL_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.CODE), STRING_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.ACK), BOOL_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.RESULT), STRING_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.STATE), DWORD_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.BUFFER), STRING_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.PREBUFFER), STRING_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.TRIGM1), BOOL_ENUM},
{&(RESOURCE1__MAIIN.PYTHON_EVAL0.TRIGGED), BOOL_ENUM},
{&(RESOURCE1__MAIIN.NOT2_OUT), BOOL_ENUM},
{&(RESOURCE1__MAIIN.STRING_TO_INT5_OUT), INT_ENUM}
};
