...
{
  UINT __res;
  BOOL __TMP_ENO = __GET_VAR(data__->BCD_TO_UINT35_ENO,);
  __res = BCD_TO_UINT__UINT__WORD(EN,
    &__TMP_ENO,
    IN);
  __SET_VAR(,data__->BCD_TO_UINT35_ENO,,__TMP_ENO);
  return __res;
}
...
void MAIN_PYTEST_init__(MAIN_PYTEST *data__, BOOL retain) {
  ...
  __INIT_LOCATED(SINT,__IB1_0,data__->TESTINPUT,retain)
  __INIT_LOCATED_VALUE(data__->TESTINPUT,0)
  __INIT_LOCATED(SINT,__QB1_0,data__->TESTOUTPUT,retain)
  __INIT_LOCATED_VALUE(data__->TESTOUTPUT,0)
  __INIT_VAR(data__->FROMINPUT,0,retain)
  __INIT_VAR(data__->TEST_BCD,300,retain)
  __INIT_VAR(data__->TEST_BCD_RESULT,0,retain)
  __INIT_VAR(data__->TEST_BCD_ENO,__BOOL_LITERAL(FALSE),retain)
  ...
  __INIT_VAR(data__->BCD_TO_UINT35_ENO,__BOOL_LITERAL(FALSE),retain)
  ...
  __INIT_VAR(data__->BYTE_TO_STRING46_OUT,__STRING_LITERAL(0,""),retain)
...
void MAIN_PYTEST_body__(MAIN_PYTEST *data__) {
  ...
  __SET_VAR(data__->,MUX21_OUT,,MUX__BOOL__SINT__BOOL(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (SINT)3,
    (UINT)4,
  ...
  __SET_VAR(data__->,MUX17_OUT,,MUX__STRING__SINT__STRING(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (SINT)3,
    (UINT)4,
  ...
  __SET_LOCATED(data__->,TESTOUTPUT,,10);
  __SET_VAR(data__->,BCD_TO_UINT35_OUT,,__MAIN_PYTEST_BCD_TO_UINT__UINT__WORD1(
    (BOOL)__BOOL_LITERAL(TRUE),
    (WORD)__GET_VAR(data__->TEST_BCD,),
    data__));
  __SET_VAR(data__->,TEST_BCD_ENO,,__GET_VAR(data__->BCD_TO_UINT35_ENO,));
  __SET_VAR(data__->,TEST_BCD_RESULT,,__GET_VAR(data__->BCD_TO_UINT35_OUT,));
  __SET_VAR(data__->,FROMINPUT,,__GET_LOCATED(data__->TESTINPUT,));
  ...
  __SET_VAR(data__->,BYTE_TO_STRING46_OUT,,BYTE_TO_STRING(
    (BOOL)__BOOL_LITERAL(TRUE),
    NULL,
    (BYTE)__BYTE_LITERAL(145)));
  __SET_VAR(data__->,TEST_STRING,,__GET_VAR(data__->BYTE_TO_STRING46_OUT,));
